...
import { CalendarDays, Download, Map, Table2 } from "lucide-react";
import {
  LineChart,
  Line,
  BarChart,
...
import { ParticipantMapDialog } from "@/components/feature/participant-map-dialog";
...
export default function Reports() {
  ...
  return (
    <>
      ...
      <ParticipantMapDialog open={mapOpen} onOpenChange={setMapOpen} />
    </>
  );
}
