...
interface ParticipantsColumnsOptions {
  t: TFunc;
  lang: string;
...
/**
 * Builds the participants table column definitions. Pure factory (no hooks) —
 * memoize at the consumption site: useMemo(() => getParticipantsColumns(...), deps).
 */
export function getParticipantsColumns({
  ...
  addParticipants,
  removeParticipants,
}: ParticipantsColumnsOptions): ColumnDef<Participant>[] {
  return [
    {
      id: "cart",
      size: 40,
